...
public class SherlockActionBarDrawerToggle implements DrawerLayout.DrawerListener {
	...
	private static class ActionBarDrawerToggleImplCompat implements ActionBarDrawerToggleImpl {
		...
		public Object setActionBarUpIndicator(Object info, Activity activity, Drawable themeImage, int contentDescRes) {
			return SherlockActionBarDrawerToggleCompat.setActionBarUpIndicator(info, activity, themeImage,
					contentDescRes);
		}
	...
	private static class ActionBarDrawerToggleImplHC implements ActionBarDrawerToggleImpl {
		...
		@Override
		public Object setActionBarUpIndicator(Object info, Activity activity, Drawable themeImage, int contentDescRes) {
			return SherlockActionBarDrawerToggleHoneycomb.setActionBarUpIndicator(info, activity, themeImage,
					contentDescRes);
		}
	...
	public void syncState() {
		...
		if (mDrawerIndicatorEnabled) {
			mSetIndicatorInfo = IMPL.setActionBarUpIndicator(mSetIndicatorInfo, mActivity, mSlider, mDrawerLayout
