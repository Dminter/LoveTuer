...
public class StatedPerference extends SharedPerferenceBase {
    ...
    public static void setOauthToke(String oauth_toke) {
        putString(getSharedPreferences(), Key.oauth_toke.toString(), oauth_toke);
    }

    public static String getOauthToke() {
        return getString(getSharedPreferences(), Key.oauth_toke.toString(), "");
    }
