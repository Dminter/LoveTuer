...
import com.zncm.lovetuer.modules.note.NoteFollowF;
import com.zncm.lovetuer.modules.note.NoteIndexF;
import com.zncm.lovetuer.modules.note.NoteNewF;
import com.zncm.lovetuer.modules.note.TipsAc;
...
public class MainTabsPager extends SherlockFragmentActivity {
    ...
    private String titles[] = new String[]{"最新日记", "我的日记", "关注的日记"};
    private SherlockActionBarDrawerToggle mDrawerToggle;
    private DrawerLayout mDrawerLayout;
    private ListView listView;
    private ActionBarHelper mActionBar;
    private static final String[] left_titles = new String[]{"登陆授权", "消息提醒", "关于我们", "注销登陆"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NoteIndexF noteF = new NoteIndexF();
        NoteFollowF note2F = new NoteFollowF();
        NoteNewF note3F = new NoteNewF();
        mMyTabsAdapter = new MyTabsAdapter(this, mViewPager);
        mMyTabsAdapter.addTab(actionBar.newTab().setText("最新日记"), NoteNewF.class, null, note3F);
        mMyTabsAdapter.addTab(actionBar.newTab().setText("我的日记"), NoteIndexF.class, null, noteF);
        mMyTabsAdapter.addTab(actionBar.newTab().setText("关注的日记"), NoteFollowF.class, null, note2F);
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch (position) {
                case 0:
                    intent = new Intent(MainTabsPager.this, LoginActivity.class);
                    startActivity(intent);
                    break;
                case 1:
                    intent = new Intent(MainTabsPager.this, TipsAc.class);
                    startActivity(intent);
                    break;
                case 2:
